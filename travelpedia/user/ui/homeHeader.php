...
<body class="vw-100">
    ...
    <div class="col-12 container-fluid scrollbar" style="overflow-x: hidden;">
        <div class="row">
                    ...
                    <div class="col-12 offset-lg-1 col-lg-10 mb-3">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-10 p-2 d-flex justify-content-end mt-3">
                                ...
                                ?>
                                    ...
                                    <a href="../../index.php" class="text-decoration-none fs-4 text-lg-end mt-4 mb-4">Sign In or Register</a>
                        ...
                        <div class="row mt-2 mb-1">
                            <div class="col-2 d-flex mt-2 mx-2">
                                <button class="col-2 btn-hotels hotels border border-light text-light" disabled>
                                    <i class="bi bi-houses fs-4"></i> &nbsp; Hotels
                                </button>
                            </div>
                            <div class="col-2 d-flex mt-2 mx-2">
                                <button class="col-2 btn-hotels hotels border border-light text-light" onclick="window.location='deals.php';">
                                    <i class="bi bi-hand-thumbs-up"></i> &nbsp; Deals
                                </button>
                            </div>
                            <div class="col-2 d-flex mt-2 mx-2">
                                <button class="col-2 btn-hotels hotels border border-light text-light" id="hist_btn" onclick="window.location='bookingHistory.php'">
                                    <i class="bi bi-clock"></i> &nbsp; Booking History
                                </button>
                            </div>
                            <div class="col-2 d-flex mt-2 mx-2">
                                <button class="col-2 btn-hotels hotels border border-light text-light" id="sche_btn" onclick="window.location='bookingSchedule.php'">
                                    <i class="bi bi-calendar4"></i> &nbsp; Booking Schedule
                                </button>
                            </div>
                            <div class="col-12 col-lg-2 offset-lg-10 dropdown mt-2">
                        ...
                        <div class="row mt-3 mb-1 mt-4 ">
                            <span class="fs-1 text-light">Find your next vacation hotspot</h2>
                                <p class="fs-4 text-light">Choose from a variety hotels, destinations and packages at the most pocket-friendly prices</p>
                        </div>
