                                ...
                                <div class="row">
                                    <div class="col-12 align-items-center border border-1 border-secondary">
                                        <li class="d-flex flex-column align-items-center mb-1">
                                            <img style="width: 100vw;" src="<?php echo $resort_data["resort_thumbnail"]; ?>" class="img-thumbnail d-flex align-items-center mt-1 mb-1" id="tnImg<?php echo $resort_data['resort_thumbnail']; ?>" onclick="loadMainImg(<?php echo $resort_data['resort_thumbnail']; ?>)" />
                                        </li>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-6 order-3">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <span class="badge" style="margin-left:3%">
                                                    ...
                                                    <span class="fs-5 text-dark fw-bold">4.5 Stars | 39 Reviews & Ratings</spa>
                                                    </span>
                                                    <hr />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <span class="fs-4 fw-bold text-dark" style="margin-left:3%">Starting From: &nbsp; &nbsp; $ <?php echo $price; ?> </span>
                                                &nbsp; &nbsp; | &nbsp; &nbsp;
                                                <span class="fs-4 fw-bold text-danger text-decoration-line-through">$ <?php echo $new_price ?></span>
                                                &nbsp; &nbsp; | &nbsp; &nbsp;
                                                <span class="fs-4 fw-bold text-black-50">Save $ <?php echo $difference; ?> (10%)</span>
                                                &nbsp; &nbsp; | &nbsp; &nbsp;
                                                <hr />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <span class="fs-4 text-primary" style="margin-left:3%">Moneyback Guarantee : 5 days Prior to Check In</span> <br />
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-4 d-grid">
                                                        ...
                                                        <input type="intval" class="fs-5 fw-bold text-center form-control" pattern="[0-9]" value="0" id="booked_double" onkeyup="checkValue(<?php echo $resort_data['double'] . ', ' . $resort_data['triple'] . ', ' . $resort_data['suite']; ?>)" />
                                                    </div>
                                                    <div class="col-4">
                                                        <span>Room Type : &nbsp;&nbsp;</span>
                                                ...
                                                <div>
                                                    <div class="row mt-4">
                                                        <div class="col-4 d-grid">
                                                            ...
                                                            <input type="intval" class="fs-5 fw-bold text-center form-control" pattern="[0-9]" value="0" id="booked_triple" onkeyup="checkValue(<?php echo $resort_data['double'] . ', ' . $resort_data['triple'] . ', ' . $resort_data['suite']; ?>)" />
                                                ...
                                                <div>
                                                    <div class="row mt-4">
                                                        <div class="col-4 d-grid">
                                                            ...
                                                            <input type="intval" class="fs-5 fw-bold text-center form-control" pattern="[0-9]" value="0" id="booked_suite" onkeyup="checkValue(<?php echo $resort_data['double'] . ', ' . $resort_data['triple'] . ', ' . $resort_data['suite']; ?>)" />
 ...
 AND `resort`.`status`='1' ORDER BY `datetime_added` DESC LIMIT 9 OFFSET 0");
        ...
        <div class="col-11">
            <div class="row me-0 mt-4 mb-3 border-bottom border-1 border-dark border-end">
                <div class="col-12">
                    <span class="fs-3 fw-bold">Nearby Resorts</span>
                </div>
            </div>
        </div>
...
INNER JOIN `province` ON `district`.`province_id` = `province`.`id`
WHERE `province`.`id`='" . $resort_data["province_id"] . "'
 AND `resort`.`status`='1' ORDER BY `datetime_added` DESC LIMIT 6 OFFSET 0");
