                ...
                <div class="card d-grid col-2 mx-5 mt-5">
                    <ul class="list-group list-group-flush">
                            ...
                            <div class="mt-2 mb-2 row" id="roomInfo">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input class="form-control mt-1" type="number" value="" id="doubleCount">
                                    </div>
                                    <div class="col-4">
                                        <label class="fw-bold" for="tripleCount">
                                            Triple
                                        </label>
                                        <input class="form-control mt-1" type="number" value="" id="tripleCount">
                                    </div>
                                    <div class="col-4">
                                        <label class="fw-bold" for="suiteCount">
                                            Suite
                                        </label>
                                        <input class="form-control mt-1" type="number" value="" id="suiteCount">
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item mt-1 mb-1">
                            ...
                            <p class="fs-6 fw-bold">Check In Dates</p>
                            ...
                            <p class="fs-6 fw-bold">Room Info</p>
                            ...
                            <div class="mt-2 mb-2 d-none row" id="offerCheck">
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <input class="form-control mt-1" type="number" value="" id="minOffer%">
                                    </div>
                                    ...
                                    <div class="col-5">
                                        ...
                                        <input class="form-control mt-1" type="number" value="" id="maxOffer%">
                                    </div>
                                </div>
                            </div>
                        </li>
