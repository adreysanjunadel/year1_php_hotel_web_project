...
<head>
    ...
    <title>Manage Resorts | Travelpedia</title>
                ...
                <div class="row g-1 text-center">
                    ...
                    <div class="nav flex-column nav-pills p-2" role="tablist" aria-orientation="vertical">
                        <nav class="nav flex-column">
                            ...
                            <a class="nav-link active" href="manageResorts.php">Manage Resorts</a>
                        </nav>
                    </div>
                    <div class="col-12">
                        <hr class="border border-1 border-white" />
            ...
            <div class="col-12 col-lg-10">
                <div class="row">
                    ...
                    <div class="text-white fw-bold mb-1 mt-3">
                        <h2 class="fw-bold text-dark m-4">Manage Resorts</h2>
                    </div>
                    <div class="col-12">
                        <hr />
                    </div>
                    <div class="col-12">
                        <div class="row g-1">
                            ...
                            <div class="col-12 mt-3">
                                <div class="row">
                                    <div class="offset-0 offset-lg-3 col-12 col-lg-6 mb-3">
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="resortSearchText" placeholder="Type to display specific results" onkeyup="resortSearch(0);"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12" id="resortSearchResult">
                                <hr />
                                <?php
                                ...
                                ?>
                                    <div class="row mt-4 align-items-center">
                                        <div class="card col-10 offset-1">
                                            <div class="card-body">
                                                <h4 class="card-title fw-bold"><?php echo $selected_data["resort_name"] . " " . $selected_data["city_name"]; ?></h4>
                                                <p class="card-text">Joined in <?php echo $selected_data["datetime_added"]; ?>
                                                    <br />
                                                    ...
                                                    ?>
                                                <div class="row mt-4">
                                                    <button class="col-10 offset-1 btn btn-outline-dark"  id="rb<?php echo $selected_data['resort_id']; ?>" class="btn btn-danger" onclick="blockResort('<?php echo $selected_data['resort_id']; ?>');">Block Resort</button>
                                                </div>
                                            <?php
                                                    } else {
                                            ?>
                                                <button id="rb<?php echo $selected_data['resort_id']; ?>" class="col-10 offset-1 btn btn-outline-success" onclick="blockResortId('<?php echo $selected_data['resort_id']; ?>');">Unblock Resort</button>
                                            <?php
