...
<body class="index-img vw-100 scrollbar" style="overflow-x: hidden;">
                    ...
                    <div class="card rounded col-12 offset-lg-2 col-lg-8 p-4 d-none" id="signUpRMContainer">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-10 offset-lg-1 mt-3" id="pass">
                                <label class="form-label fw-bold fs-5 d-flex">Password <label class="fw-light fs-6 mt-1"> &nbsp; Must include 1 Uppercase, 1 Lowercase, 1 Number, 1 Special Character (min 8 characters) </label> &nbsp; <label class="d-none fw-bold" id="starP" style="color:red;">*</label></label>
                                <input type="password" placeholder="Enter a Password between 8 and 24 Characters" class="form-control 4" id="pw" />
                            </div>
                            <br />
